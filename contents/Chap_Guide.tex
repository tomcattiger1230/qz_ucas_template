...
为方便使用及更好地展示\LaTeX{}排版的优秀特性，本模版的框架和文件体系进行了细致地处理，尽可能地对各个功能和板块进行了模块化和封装，对于初学者来说，众多的文件目录也许一开始让人觉得有些无所适从，但阅读完下面的使用说明后，会发现原来使用思路是简单而清晰的，而且，当对\LaTeX{}有一定的认识和了解后，会发现其相对Word类排版系统极具吸引力的优秀特性。所以，如果是初学者，请不要退缩，请稍加尝试和坚持，以领略到\LaTeX{}的非凡魅力，并可以通过阅读相关资料如\LaTeX{} Wikibook \citep{wikibook2014latex} 来完善自己的使用知识。
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.40\textwidth]{images/c06h06}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[trim = 60mm 80mm 60mm 60mm, clip, width=0.40\textwidth]{images/c06h06}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.35\textwidth}
      \includegraphics[width=\textwidth]{images/oaspl_a}
      \caption{}
      \label{fig:oaspl_a}
    \end{subfigure}%
    ~% add desired spacing
    \begin{subfigure}[b]{0.35\textwidth}
      \includegraphics[width=\textwidth]{images/oaspl_b}
      \caption{}
      \label{fig:oaspl_b}
    \end{subfigure}
    \\% line break
    \begin{subfigure}[b]{0.35\textwidth}
      \includegraphics[width=\textwidth]{images/oaspl_c}
      \caption{}
      \label{fig:oaspl_c}
    \end{subfigure}%
    ~% add desired spacing
    \begin{subfigure}[b]{0.35\textwidth}
      \includegraphics[width=\textwidth]{images/oaspl_d}
      \caption{}
      \label{fig:oaspl_d}
    \end{subfigure}
...
另外，对于个别图片需要引用参考文献，为不影响文献的排序，需要使用额外的标记方式，如下所示：
\begin{enumerate}
    \item \verb|\caption[AAA]{AAA~\protect\cite{ACite}}|
    \item \verb|\bicaption[AAA]{AAA~\protect\cite{ACite}}[BBB]{BBB~\protect\cite{BCite}}|
\end{enumerate}
...
不同文献样式和引用样式，如著者-出版年制（authoryear）、顺序编码制（numbers）、上标顺序编码制（super）可在Thesis.tex中对artratex.sty调用实现，详见 \href{https://github.com/mohuangrui/ucasthesis/wiki}{ucasthesis 知识小站之文献样式}\cite{niu2013zonghe}
